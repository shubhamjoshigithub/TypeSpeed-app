...
quoteDisplay.addEventListener("copy", function() {
    quoteInput.placeholder = "No cheating son!!";
    getAndAppendQuote();
});
...
resetBtn.addEventListener("click", function() {
    ...
    speedTypingTest.classList.add("temp-height", "d-flex", "align-items-center", "justify-content-center");
    ...
    let spinId = setInterval(function() {
        ...
        if (spincount === 1) {
            ...
            speedTypingTest.classList.remove("temp-height", "d-flex", "align-items-center", "justify-content-center");
            quoteInput.value = "";
            result.textContent = "";
            timer.textContent = 0;
        }
